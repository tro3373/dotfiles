...
if not exist "%hosts%" (
    ...
    rem Install pakages
    %bin%\bash.exe -c "/usr/bin/pacman -S --noconfirm man zsh vim git winpty svn wget sed diffutils grep tar unzip patch mingw-w64-x86_64-gcc make gcc bc mingw-w64-x86_64-ag"
