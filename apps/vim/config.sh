...
#        dvexec "$instcmd --force-yes vim vim-gtk vim-athena vim-gnome"
        ...
        dvexec ./configure --enable-multibyte \
            --with-features=huge \
            --enable-luainterp \
            --enable-perlinterp \
            --enable-pythoninterp \
