...
if lua_mode then
  ...
  local function apply_markdown_hl()
    ...
    vim.api.nvim_set_hl(0, "@markup.heading.4.markdown", { fg = p.h4.gui, ctermfg = p.h4.cterm })
    vim.api.nvim_set_hl(0, "@markup.heading.5.markdown", { fg = p.h5.gui, ctermfg = p.h5.cterm })
    vim.api.nvim_set_hl(0, "@markup.heading.6.markdown", { fg = p.h6.gui, ctermfg = p.h6.cterm })
