...
if g:plug.is_installed('memolist.vim')
    ...
    let g:memolist_filename_prefix_none = 1                     " remove filename prefix (default 0)
    let g:memolist_qfixgrep = 0                                 " use qfixgrep (default 0)
    let g:memolist_vimfiler = 0                                 " use vimfler (default 0)
    let g:memolist_unite = 1                                    " use unite (default 0)
    ...
    let g:memolist_delimiter_yaml_array = "---"                 " first line string pattern of yaml front matter (default '==========')
    let g:memolist_delimiter_yaml_array = "---"                 " last line string pattern of yaml front matter (default '---')
